        ...
        >
          <div className="w-full flex flex-col md:flex-row gap-6 md:gap-16 items-center">
            ...
            <div className="flex flex-col gap-4 md:gap-8 md:w-2/3">
              ...
              {/* 查看简历：新标签页打开 public 里的 PDF */}
              <a
                href={encodeURI("/马超越昊-前端全栈简历.pdf")}
                target="_blank"
                rel="noopener noreferrer"
                className="hero-resume-btn group inline-flex items-center gap-2.5 w-fit text-sm md:text-base font-semibold transition-all duration-300"
